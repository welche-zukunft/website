			...
			<div class="formular">
				...
				<div id="anmeldeformular">
					<form method="POST" action="/adduser/" id="anmeldung_form">
						<p> The Registration expired on September 9. 2017, 12 pm<br>
						On September 9. all participants will be asked to confirm attendance - deadline for this confirmation will be September 13. and mandatory for your participation. <br><br>
						Free waiting list positions will be raffled on September 14. and allocated to those on the list. <br>
					</form><!-- anmeldung -->
				</div><!-- anmeldeformular -->
				<div id="newsletter">
